...
console.log("I have found a bigger dinner table now")

console.log("\n")

guestlist.unshift("Uncle's Family");

guestlist.splice(2, 0, "Friend's Family")

guestlist.push("Taya's Family");

for (let gl =0; gl < guestlist.length; gl++){
    console.log(`I would like to invite ${guestlist[gl]} today for dinner at my home`)
}